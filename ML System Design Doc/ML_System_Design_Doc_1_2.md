...
## Дизайн ML системы - nanozymes_ai (MVP). вер.1.2 </h1>
...
Выбрана модель multilingual-e5-large. Критерий выбора - качество и производительность. Сравнение производилось на лидерборде https://github.com/avidale/encodechka
